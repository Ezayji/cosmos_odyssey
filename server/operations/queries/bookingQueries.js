...
const insertNewBooking = async (data) => {
    ...
    const text = 'INSERT INTO bookings (id, first_name, last_name, routes, price, travel_time, transport_company_names, price_list_id, date) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)';
    const date = Date.now();
    try{    
        await pool.query(text, [id, first_name, last_name, routes, price, travel_time, transport_company_names, price_list_id, date]);
        return true;
    } catch (e) {
